<?php
namespace CGB\Relax5datepicker\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class CGB\Relax5datepicker\Controller\HolidayController.
 *
...
class HolidayControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \CGB\Relax5datepicker\Controller\HolidayController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('CGB\\Relax5datepicker\\Controller\\HolidayController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllHolidaysFromRepositoryAndAssignsThemToView()
	{
		...
		$holidayRepository = $this->getMock('CGB\\Relax5datepicker\\Domain\\Repository\\HolidayRepository', array('findAll'), array(), '', FALSE);
